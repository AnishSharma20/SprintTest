...
/** Ordered from most to least AKBM involvement. `competitor` and `third_party` are not "less
 * involvement" versions of the others, they are different in kind: the paper is not about an AKBM
 * product at all, or is not a trial of one product. */
