...
// Content Generator V2 — a guided, step-by-step rebuild of /generator ("Option B: Guided" from the
// redesign pitch). Deliberately a SEPARATE page/route from the original, not a refactor of it: the
// original stays untouched at /generator so it keeps working exactly as before while this one is
// tried out. Some constants/logic below are intentionally duplicated from app/generator/page.tsx
// rather than shared, for that same reason — don't let a "V2" page reach back and risk the original.
//
// Same backend, same /api/generate-deck contract, same validation rules as V1 — only the UI is
// restructured into one focused question per screen instead of one long scrolling form.
...
export default function ContentGeneratorV2() {
      ...
      <div className="mx-auto max-w-2xl px-5 py-10">
        ...
        <div className="mb-7 flex items-center justify-between">
          <span className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-[#6D8894]">
            Content Generator <span className="text-[#3FD0C9]">V2</span>
          </span>
